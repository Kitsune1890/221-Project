...
public class Vactination {
	...
	public Vactination(String name, int startMonth, int vacPeriod) {
		super();
		this.Name = name;
	...
	public Vactination(String name, int startMonth, int vacPeriod, ArrayList<Calendar> vactinationDates) {
		super();
		this.Name = name;
		this.StartMonth = startMonth;
		this.vacPeriod = vacPeriod;
